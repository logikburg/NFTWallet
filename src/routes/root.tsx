...
import { SolanaOwnAssetsGrid } from '../components/SolanaOwnAssetsGrid';
...
import { SolanaOwnAssetsForm } from '../components/SolanaOwnAssetsForm';
                ...
                <Flex gap="6" direction="column">
                    ...
                    <Box flexGrow="1">
                        <ErrorBoundary
                            ...
                            resetKeys={errorBoundaryResetKeys}
                        >
                            <SolanaOwnAssetsGrid account={selectedWalletAccount} />
                        </ErrorBoundary>
                    </Box>
                </Flex>
            ) : (
